...
public class UI_InteractionController : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        // Adjusting the max raycast distance for the UI interaction
        UIController.GetComponent<XRRayInteractor>().maxRaycastDistance = 100.0f; // Adjust this value as needed
    }
